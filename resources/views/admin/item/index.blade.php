                  ...
                  <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered" >
                      ...
                      <tr>
                        ...
                        <td>{{$item->link}}</td>
                        <td><img src="{{asset('public/uploads/item/'.$item->image)}}" alt="" height="60px" width="60px"></td>
                        <td class="td-actions text-left">
                                  ...
                                  <i class="fa-solid fa-pen-to-square"></i>
                                   ...
                                   <button type="submit" rel="tooltip" title="Remove" class="btn btn-link btn-sm mx-2" onclick="if(
                                  ...
                                  <a href="{{ route('item.show',$item->id)}}" style="float:left;display:none" style="margin-left:20px">
